...
/**
 * WebEnquiryForm — Reusable dark pill-style enquiry form
 *
 * Props:
 *  @param {string}   formTitle       - Main heading        (default: "Ready to build?")
 ...
 */
const WebEnquiryForm = ({
  formTitle = "Ready to build?",
  formSubtitle = "Fill out the form below and our web experts will be in touch.",
...
//   <WebEnquiryForm
//     formTitle="Let's build something great"
//     formSubtitle="Drop your details and we'll call you back."
//     serviceOptions={["SEO", "Google Ads", "Meta Ads", "Branding"]}
//     submitLabel="Get a Free Quote"
//   />
//
// Custom accent (blue):
//   <WebEnquiryForm accentColor="#3b82f6" />
//
// Custom API + redirect:
//   <WebEnquiryForm
...
//
// Constrained width:
//   <WebEnquiryForm className="max-w-lg mx-auto" />
